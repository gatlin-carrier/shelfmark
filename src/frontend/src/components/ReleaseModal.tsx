...
export const ReleaseModal = ({
  ...
  const handleReleaseAction = useCallback(
    ...
    [book, isCombinedMode, getReleaseActionMode, onDownload, onRequestRelease, contentType, handleClose, showDualDownload, compSelectedRelease, compDismissed, onDualDownload, complementaryContentType]
  );
