...
def api_config() -> Union[Response, Tuple[Response, int]]:
    ...
    try:
        ...
        config = {
            ...
            "dual_download_enabled": app_config.get("DUAL_DOWNLOAD_ENABLED", False, user_id=db_user_id),
            "dual_download_preferred_format": app_config.get("DUAL_DOWNLOAD_PREFERRED_FORMAT", "", user_id=db_user_id),
            "dual_download_fallback_format": app_config.get("DUAL_DOWNLOAD_FALLBACK_FORMAT", "", user_id=db_user_id),
            "dual_download_max_size_mb": app_config.get("DUAL_DOWNLOAD_MAX_SIZE_MB", 0, user_id=db_user_id),
